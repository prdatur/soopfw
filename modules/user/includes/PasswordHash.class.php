...
class PasswordHash {
	...
	function __construct($iteration_count_log2 = 6, $portable_hashes = false) {
	...
	/**
	 * Checks the given $password against the $stored_hash.
	 *
	 * @param string $password
	 *   the plaintext password to check
	 * @param string $stored_hash
	 *	 the stored hased password
	 *
	 * @return boolean
	 *	 true if password match, else false
	 */
