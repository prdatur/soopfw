...
class GeSHi {
    ...
    /**
     * Whether the caches needed for parsing are built or not
     *
     * @var bool
     * @since 1.0.8
     */
    ...
    /**
     * Sets whether spans and other HTML markup generated by GeSHi can
     ...
     *
     * @param boolean Whether multiline spans are allowed or not
     * @since 1.0.7.22
     */
     ...
     * @param bool   Whether to automatically recompile the optimized regexp list or not.
                            ...
                            if ($this->lexic_permissions['ESCAPE_CHAR'] && $part[$close_pos - 1] == $this->language_data['HARDCHAR'] &&
                                ...
                                foreach ($this->language_data['HARDESCAPE'] as $hardescape) {
                                    if (substr($part, $close_pos - 1, strlen($hardescape)) == $hardescape) {
                                        // check whether this quote is escaped or if it is something like '\\'
...
//        $result = substr($result, 1, -1);
    ...
    * @param $recursed bool to know whether we recursed or not
    * @return string
    * @author Milian Wolff <mail@milianw.de>
    * @since 1.0.8
    * @access private
