...
class Smarty_Internal_Data {
    ...
    */
	...
	/**
     * assigns values to template variables for javascript with json_encode
     *
     * @param string $tpl_var the template variable name
     * @param mixed $value the referenced value to assign
     */
    function assign_json($tpl_var, &$value)
    {
        if ($tpl_var != '')
           $this->tpl_vars[$tpl_var] = new Smarty_variable(json_encode($value));
    }
	/**
     * assigns values to template variables for javascript with json_encode but not by reference
     *
     * @param string $tpl_var the template variable name
     * @param mixed $value the referenced value to assign
     */
    function assign_json_no_reference($tpl_var, $value)
    {
        if ($tpl_var != '')
		{
			$this->tpl_vars[$tpl_var] = new Smarty_variable(json_encode($value));
     ...
     * @param mixed $value the referenced value to assign
     */
    function assign_array_by_ref(Array &$value)
    {
    	foreach ($value as $key => $val)
		{
			if ($key != '')
			{
				$this->tpl_vars[$key] = new Smarty_variable(null);
				$this->tpl_vars[$key]->value = &$val;
            }
        }
    }
